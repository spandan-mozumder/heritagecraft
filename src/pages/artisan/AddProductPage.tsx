...
const AddProductPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // In a real app, this would upload images and save product data
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-4">
              <button
                ...
                disabled={isLoading}
                className="px-6 py-3 bg-gray-500 hover:bg-gray-600 disabled:bg-gray-400 text-white font-semibold rounded-xl transition-colors duration-200 disabled:cursor-not-allowed flex items-center"
              >
                {isLoading ? (
